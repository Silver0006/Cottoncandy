...
:start1
ECHO.
Echo ----CottonCandy 0.1.4 Created by Aidan Patrick Marias----
ECHO 1. Windows 10
...
ECHO 2. Delete Hidden Files (Proceed with Caution
ECHO 3. Find Wifi Password 
ECHO Y. Go back
ECHO Z. End
...
if '%choice%'=='2' goto delhidden
if '%choice%'=='3' goto findwifi
if '%choice%'=='Y' goto start1
if '%choice%'=='Z' goto End
